...
import { validateRedemptionCode, formatRedemptionCode } from '$lib/server/services/codes';
...
export const POST: RequestHandler = async ({ request }) => {
	...
	if (existingCode.redeemedByFingerprint && existingCode.redeemedByFingerprint !== fingerprint) {
		return json(
			{
